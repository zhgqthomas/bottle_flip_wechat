    ...
    return a(e, [ {
        ...
        value: function(e) {
            function t(e, i) {
                wx.showLoading({
                    ...
                    wx.hideLoading(), wx.showModal({
                        ...
                        cancelText: "取消",
                        success: function(a) {
                            a.confirm ? t(e, i) : v && k.onHide && k.onHide();
                        },
                        fail: function() {
                            v && k.onHide && k.onHide();
                        }
            ...
            function l(e, t) {
                ...
                k.scene = f, k.skinResources = t, k.gameData = e, b ? k.CalGameExtraData(function(e, t) {
                    i(e, t);
                }) : i();
            }
            var d = e.user_data, f = e.scene, p = e.callback, v = e.is_from_share, _ = e.onHide, y = e.playback_poster;
            if (!this.isInThisPage) {
                var k = this, w = d && d.playback_id, b = d && d.is_self, T = this.game.skinManager;
                this.onHide = _ || this.onHide, this.playback_poster = y, this.isInThisPage = !0, 
                t(function(e, t) {
        ...
        key: "destroy",
        value: function(e) {
            this.isInThisPage && (this.reviewPage.hide(), this.game.resetScene(), h.default.emitSync(l.EVENT.GOTOSINGLESTARTPAGE, {}), 
        ...
        value: function(e, t, i) {
            var a = this;
            this._destroy();
            var s = t.seed, n = t.action, o = t.musicList, r = t.timestamp, u = t.version, c = t.use_wangzhe, h = t.mmpay_status, l = t.use_mmpaybase, m = t.skin_id, d = t.property, g = n, f = r, p = 0, v = void 0;
            ...
            this.index = 0, this.game.resetScene(s, {
                ...
                skinId: m || null
            }), v = 0; v < this.actionList.length - 1 && v < e; v++) !function(e) {
            ...
            this.index = v, i(p, this.game.succeedTime);
        }
    }, {
        key: "continue",
        value: function() {
