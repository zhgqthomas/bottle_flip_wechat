...
var i = function () {
    ...
    }(require("../lib/three")), s = require("../config"), n = e(require("../text")), r = require("../lib/animation"),
    o = (e(require("../store/storage")),
        e(require("../scroll/scrollHandler")), e(require("../report")), require("./pages2d/base")),
    h = require("./pages2d/start"), l = require("./pages2d/beginner"), y = require("./pages2d/lookers"),
    c = require("./pages2d/pk"), u = require("./pages2d/rank"), p = require("./pages2d/gg"),
    d = require("./pages2d/verify"), v = require("./pages2d/relay"), T = require("./pages2d/record"),
    f = require("./pages2d/profile"), g = require("./pages2d/msg"), k = require("./pages2d/skin"),
    w = require("./pages2d/shareskin"), A = e(require("../lib/mue/eventcenter")), m = e(require("./headimgAnimation")),
    S = window.devicePixelRatio > 2 ? 2 : window.devicePixelRatio,
    E = window.innerHeight < window.innerWidth ? window.innerHeight : window.innerWidth,
    x = window.innerHeight > window.innerWidth ? window.innerHeight : window.innerWidth, _ = x * S, P = E * S,
    R = ["btn", "list1", "list2", "bg"], b = s.FRUSTUMSIZE, C = (wx.loadFont("res/num.ttf"),
        function () {
            function e(i) {
                var h = this;
                ...
                this.options.friendRankReturn = i.friendRankReturn;
                this.options.groupPlayGame = i.groupPlayGame;
                this.options.onClickRank = i.onClickRank;
                this.options.onClickReplay = i.onClickReplay;
                this.options.onClickShare = i.onClickShare;
                this.options.onClickPureShare = i.onClickPureShare;
                this.options.onClickStart = i.onClickStart;
                this.options.onShowFriendRank = i.onShowFriendRank;
                this.options.onBattlePlay = i.onBattlePlay;
                this.options.onLookersStart = i.onLookersStart;
                this.options.newRelay = i.newRelay;
                this.options.outRelay1 = i.outRelay1;
                this.options.outRelay2 = i.outRelay2;
                this.options.startRelay = i.startRelay;
                this.options.shareRelay = i.shareRelay;
                this.options.replayRelay = i.replayRelay;
                this.options.skipRelayBeginner = i.skipRelayBeginner;
                this.options.getRelayQr = i.getRelayQr;
                this.options.quitRecord = i.quitRecord;
                A.default.on(s.EVENT.RELAYSTART, function (e, t) {
                    h.hide2D(), h.relayHeadImg || (h.relayHeadImg = new m.default()), h.relayText || (h.relayText = new a.Object3D(),
                        ...
                        h.relayHeadImg.obj.position.x = -8.8, h.relayHeadImg.obj.position.y = 20, _ / P < 736 / 414 && (h.relayHeadImg.obj.position.y = 14,
                        h.relayText.position.y = 6), t.my_seat_no == t.now_player_seat_no && (h.turnText.obj.visible = !0,
                    ...
                    h.relayHeadImg || (h.relayHeadImg = new m.default()), h.relayHeadImg.next(t), t.my_seat_no == t.now_player_seat_no ? (h.turnText.obj.visible = !0,
                        h.outText.obj.visible = !1) : (h.turnText.obj.visible = !1, h.outText.obj.visible = !1);
                }), A.default.on(s.EVENT.PLAYERDIED, function (e, t) {
                    if (h.canvasType == o.CANVASTYPE.relayRoom) {
                        h.outText.obj.visible = !0, h.turnText.obj.visible = !1;
                        var i = t.playerlist.filter(function (e) {
                            return 0 === e.rank;
                        });
                        t.my_seat_no == t.now_player_seat_no && i.length > 2 && h.showRelayGG({
                    ...
                    s && s.rank >= 0 && (i = s.rank + 1), r.TweenAnimation.killAll(), h.showRelayRank({
