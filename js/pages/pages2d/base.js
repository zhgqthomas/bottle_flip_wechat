...
function o(e) {
    var t = e * g / 414;
    return w / g < 736 / 414 && (t = e * w / 736 + (g - 414 * w / 736) / 2), t * d;
}

function a(e) {
    return (w / g > 736 / 414 ? e * g / 414 + (w - 736 * g / 414) / 2 : e * w / 736) * d;
}
    ...
    n.onload = function () {
        if (t.self.imgid[t.type] == t.imgid) {
            if (t.round) {
                ...
                i(o(t.pos[0]) - r(t.pos[2]) / 2, p, r(t.pos[2]), r(t.pos[3]), t.radius, s);
                s.clip();
                s.globalAlpha = t.alpha;
                s.drawImage(n, o(t.pos[0]) - r(t.pos[2]) / 2, p, r(t.pos[2]), r(t.pos[3]));
                s.globalAlpha = 1;
                s.closePath();
                s.restore();
            } else {
                s.globalAlpha = t.alpha;
                const dx = o(t.pos[0]) - r(t.pos[2]) / 2;
                const dy = a(t.pos[1]) - r(t.pos[3]) / 2;
                const dWidth = r(t.pos[2]);
                const dHeight = r(t.pos[3]);
                "list1" == t.type || "list2" == t.type ? s.drawImage(n, o(t.pos[0]) - r(t.pos[2]) / 2, r(t.pos[1]) - r(t.pos[3]) / 2, r(t.pos[2]), r(t.pos[3])) : s.drawImage(n, o(t.pos[0]) - r(t.pos[2]) / 2, a(t.pos[1]) - r(t.pos[3]) / 2, r(t.pos[2]), r(t.pos[3]));
                s.globalAlpha = 1;
            }
...
Object.defineProperty(exports, "__esModule", {
    ...
    exports.createPlane = function (e, t) {
        if (n(e, t), e.showState = !0, !e.canvas.bg) {
            ...
            for (var o = 0; o < y.length; o++) {
                ...
                "list1" == y[o] || "list2" == y[o] ? e.canvas[y[o]].height = r(720) : e.canvas[y[o]].height = x;
                e.texture[y[o]] = new u.Texture(e.canvas[y[o]]);
                e.material[y[o]] = new u.MeshBasicMaterial({
                    map: e.texture[y[o]],
                    transparent: !0
                });
                ...
                e.obj[y[o]].position.x = 0;
                e.obj[y[o]].position.z = 9 - .001 * o;
            }
            T && I && (e.context.sample, setTimeout(function () {
                p({
                    self: e,
                    src: "res/sample.png",
                    pos: [207, 368, 414, 736],
    ...
    n.canvasType == v.relayRank && 1 == n.opt.my_rank || n.canvasType == v.pk ? t(d, r.clone(), !0) : t(d, r.clone());
    var g = (f = new u.Triangle(i, p)).plane();
    t(g, r.clone());
    var w = (f = new u.Triangle(l, i)).plane();
    t(w, r.clone());
    var y = (f = new u.Triangle(s, l)).plane();
    t(y, r.clone()), n.material.list1.clippingPlanes = [d, g, w, y], n.material.list1.needsUpdate = !0,
        n.material.list2.clippingPlanes = [d, g, w, y], n.material.list2.needsUpdate = !0;
    ...
    i.beginPath(), i.lineWidth = p * d, i.strokeStyle = s, i.moveTo(o(e), a(t)), i.lineTo(o(n), a(r)),
        i.stroke(), i.closePath();
}, exports.drawHomeImg = function (t, n) {
    var r = new Image();
    r.onload = function () {
        1624 == x && 750 == m ? t.drawImage(r, 10 * d, 44 * d, 104, 64) : t.drawImage(r, 10 * d, 10 * d, 104, 64),
            e({
                self: n,
                type: "bg"
            });
    ...
    var r = new Image();
    r.onload = function () {
        1624 == x && 750 == m ? t.drawImage(r, 10 * d, 45 * d, 86, 64) : t.drawImage(r, 10 * d, 10 * d, 86, 64),
            e({
                self: n,
                type: "bg"
            });
    ...
    for (var n = Math.min(e.length, t.length), r = 0; r < n; r++) {
        if (parseInt(e[r]) > parseInt(t[r])) return !1;
        if (parseInt(e[r]) < parseInt(t[r])) return !0;
    }
    return !0;
}, exports.gtAppVersion = function (e) {
...
var u = function (e) {
    ...
    g = (exports.realDpr = window.devicePixelRatio,
        exports.W = window.innerHeight < window.innerWidth ? window.innerHeight : window.innerWidth),
    w = exports.H = window.innerHeight > window.innerWidth ? window.innerHeight : window.innerWidth,
    x = exports.HEIGHT = w * d, m = exports.WIDTH = g * d, y = ["btn", "list1", "list2", "bg"],
    v = exports.CANVASTYPE = {
        friendRank: 0,
        groupRank: 1,
        gameOver: 2,
        start: 3,
        ...
        jiliProp: 23,
        msgDetail5: 24
    }, h = exports.frustumSizeHeight = f.FRUSTUMSIZE, b = exports.frustumSizeWidth = m / x * h,
    T = exports.DEBUGVIEW = !1, I = !1, V = (exports.ListLineHeight = 60,
