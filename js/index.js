...
var s = function (t) {
    ...
    d = t(require("./ui/audioManager")), u = t(require("./tailSystem")), m = t(require("./lib/point-in-polygon")),
    ...
    y = (t(require("./pages/singleSettlementPage")),
        require("./shareApp")), x = t(require("./viewer")), w = require("./lib/animation"),
    B = t(require("./store/historyTimes")), T = t(require("./network/reporter")), S = t(require("./gameCtrl")),
    C = t(require("./gameView")), j = t(require("./gameModel")), L = require("./random"),
    M = t(require("./control/instructionCtrl")), O = t(require("./control/relayInstructionCtrl")),
    P = t(require("./lib/mue/eventcenter")), R = t(require("./control/onebyoneCtrl")),
    I = t(require("./control/bottleSkinBaseCtrl")), z = require("util/encryption"),
    E = t(require("./network/relayMoniter")), _ = t(require("./lib/mue/lookcenter")), A = t(require("./skin")),
    q = t(require("./control/propertyCtrl")),
    D = window.innerHeight > window.innerWidth ? window.innerHeight : window.innerWidth,
    G = window.innerHeight < window.innerWidth ? window.innerHeight : window.innerWidth,
    U = wx.getSystemInfoSync() || {}, F = "ios" == U.platform, V = U.model, K = function () {
        function t(i) {
        ...
        return o(t, [{
                    ...
                    if (this.guider && (this.guider = !1, this.full2D.hide2DGradually()), !this.animating) {
                        ...
                        !this.nextBlock.succeedTimer && void 0 === this.nextBlock.score && !this.nextBlock.musicName || t && t.noAnimation || "relay" == this.mode) t && t.musicScore && "relay" != this.mode && (31 == this.nextBlock.order && (this.nextBlock.score = this.mmpayScore),
                            ...
                            this.musicTimer = setTimeout(function () {
                                ...
                                })), n.succeedTimer && n.succeedTimer(e.UI.score, e.bottle.obj.position.clone()),
                                32 == n.order && (e.relaxLeft += 2);
            ...
            value: function () {
                this.show = !1, "prepare" == this.bottle.status && (this.touchObserve = !0), this.animateTimer && (clearTimeout(this.animateTimer),
                    ...
                    this.onshowAnimateTimer = null), this.gameCtrl.wxOnhide(), _.default.stopScenes("global");
            }
        }, {
            key: "init",
            value: function () {
                var t = this, e = wx.getSystemInfoSync();
                console.log("getSystemInfo :", e), b.default.getFirstBlood() || this.options.query.mode || (this.guider = !0),
                ...
                this.camera = new s.OrthographicCamera(i * o / -2, i * o / 2, i / 2, i / -2, -10, 85),
                    ...
                    this.blocksRemoved = {}, this.doubleHit = 0, F && (V.indexOf("iPhone 4") >= 0 || V.indexOf("iPhone 5") >= 0 || U.system.indexOf("iOS 9") >= 0 || U.system.indexOf("iOS 8") >= 0 || V.indexOf("iPhone 6") >= 0 && V.indexOf("iPhone 6s") < 0) ? (this.renderer.shadowMap.enabled = !1,
                ...
                wx.onAudioInterruptionBegin && wx.onAudioInterruptionBegin(this.handleInterrupt.bind(this)),
                    g.default.sceneLogin(function (t) {
            ...
            value: function () {
                ...
                if (this.clearTimer(), this.animating) {
                    ...
                    this.touchStartTimer = setTimeout(function () {
                        t.bottle.velocity.vz = Math.min(.719 * c.BOTTLE.velocityZIncrement, 180);
                        t.bottle.velocity.vy = Math.min(c.BOTTLE.velocityY + .719 * c.BOTTLE.velocityYIncrement, 180);
                        ...
                        t.thirdBlock = t.generateNextBlock();
            ...
            value: function (t) {
                ...
                this.guiderTimer && !this.guider && (clearInterval(this.guiderTimer), this.guiderTimer = null);
            ...
            key: "wellJump",
            value: function (t) {
                var e = t.property_id, i = void 0 === e ? "" : e, o = t.item_id, n = void 0 === o ? "" : o, r = t.quick,
                    a = void 0 !== r && r, h = (t.musicScore,
            ...
            value: function (t, e, i, o) {
                ...
                var h = [], l = new s.Vector2(t.obj.position.x, t.obj.position.z),
                    d = this.direction.setLength(t.velocity.vz * n);
                if (l.add(d), t.destination = [+l.x.toFixed(2), +l.y.toFixed(2)], h.push(+l.x.toFixed(2), +l.y.toFixed(2)),
                    this.animating) return {
                    hit: 7
                };
                if (i) {
                    var u, g = Math.pow(h[0] - i.obj.position.x, 2) + Math.pow(h[1] - i.obj.position.z, 2),
                        b = i.getVertices();
                    (0, m.default)(h, b) ? u = Math.abs(g) < .5 ? 1 : 7 : (0, m.default)([h[0] - c.BOTTLE.bodyWidth / 2, h[1]], b) || (0,
                        m.default)([h[0], h[1] + c.BOTTLE.bodyDepth / 2], b) ? u = 5 : ((0, m.default)([h[0], h[1] - c.BOTTLE.bodyDepth / 2], b) || (0,
                        m.default)([h[0] + c.BOTTLE.bodyDepth / 2, h[1]], b)) && (u = 3);
                }
                var p = e.getVertices();
            ...
            value: function (t) {
                "relay" == this.mode ? this.use_mmpaybase = this.mmpay_status = this.use_wangzhe = !0 : (this.use_mmpaybase = t && void 0 !== t.use_mmpaybase ? t.use_mmpaybase : b.default.getMmpayBaseStatus(),
                    this.mmpay_status = t && void 0 !== t.mmpay_status ? t.mmpay_status : b.default.getMmpayBonusStatus().status,
                    this.mmpayScore = this.mmpay_status ? 20 : 5, this.mmpay_checksum = b.default.getMmpayBonusStatus().checksum,
                    this.use_wangzhe = t && t.use_wangzhe || b.default.getWangZheBaseStatus());
            }
        }, {
            key: "addToPool",
            value: function (t) {
            ...
            value: function (t, e) {
                var i = this;
                if (console.log("resetScene"), this.reviewVersion = null, this.object_id_list = c.LOCALBLOCK.slice(0),
                    this.skin_id = this.skin_sn = void 0, e && e.version && (this.reviewVersion = e.version),
                    this.touchObserve = !1, this.firstAnimating = !1, this.myTurn = !1, this.clicked = !1,
                    this.pendingReset = !1, this.blocks && this.blocks.length > 0) for (var o = 0, s = this.blocks.length; o < s; ++o) this.scene.remove(this.blocks[o].obj);
            ...
            value: function () {
                ...
                return g.default.sendServerError(7), null === t && g.default.sendServerError(8),
            ...
            value: function () {
                ...
                P.default.on(c.EVENT.GOTOSINGLESTARTPAGE, function (e, i) {
                    t.clearTimer(), t.animating = !0, console.log("gotoSinglepage"), t.loopAnimate();
                        ...
                        "relay" != e.mode || "game" != e.stage || !e.clicked && e.myTurn) if (e.gameCtrl.reviewCtrl.isInThisPage) e.gameCtrl.reviewCtrl.reviewPage.doTouchStartEvent(t); else {
                            if ("single" == e.mode || "player" == e.mode) {
                                ...
                                if ("game" == e.stage && !e.is_from_wn && !e.guider) {
                                    if (i < .13 * G && o > .88 * D) return "prepare" == e.bottle.status && (e.touchObserve = !0),
