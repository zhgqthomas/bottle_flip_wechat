...
var a = Object.assign || function(e) {
...
}(), r = e(require("../pages/single/singleStartPage")), n = e(require("../pages/single/singleGamePage")), o = e(require("../pages/single/singleGameOverPage")), s = e(require("../pages/single/singleFriendRankPage")), l = e(require("../pages/single/relayGuide")), g = e(require("../control/profileCtrl")), h = e(require("../control/bottleSkinShopCtrl")), u = require("../shareApp"), d = e(require("../network/network")), c = e(require("../lib/mue/eventcenter")), f = e(require("../lib/mue/lookcenter")), m = e(require("./msgBoxCtrl")), k = e(require("../store/storage")), v = require("../config"), P = e(require("./propertyCtrl")), p = e(require("../control/bottleSkinBaseCtrl")), S = function() {
    function e(a, i) {
    ...
    return i(e, [ {
        ...
        value: function() {
            ...
            this.MsgBoxCtrl ? this.MsgBoxCtrl.init(t) : (this.MsgBoxCtrl = new m.default({
                game: this.game,
                onReturn: function() {
                ...
                onGoProfile: function(t) {
                    var i = k.default.getMyUserInfo(), r = !1;
        ...
        value: function() {
            ...
            P.default.canUseProp(1) ? this.gamePage.show({
                usingProp: 1
            }) : this.gamePage.show(), this.game.replayGame(), this.model.setStage(this.gamePage.name), 
            this.currentPage = this.gamePage, f.default.startScenes("single");
        }
    }, {
        key: "touchProp",
        value: function(e) {
        ...
        value: function() {
            ...
            this.hideCurrentPage(), t.onRewardAdGetProp = function() {
                e.onRewardAdGetProping || (e.onRewardAdGetProping = !0, d.default.getAdReward().then(function(t) {
                    e.onRewardAdGetProping = !1, e.gameOverPage.showAdReward(t.icon || "xxx");
                }, function() {
                    e.onRewardAdGetProping = !1, wx.showToast({
                        title: "道具发放失败",
                        icon: "none",
                        duration: 800
                    }), console.log("道具发放失败");
                }));
            }, t.onShowRewardAd = function() {
            ...
            this.currentPage = this.gameOverPage, f.default.stopScenes("single");
        }
    }, {
        ...
        key: "showFriendRank",
        value: function(e) {
            f.default.startScenes("rank"), e || (this.lastPage = this.currentPage), this.hideCurrentPage(), 
        ...
        value: function() {
            f.default.stopScenes("rank"), this.hideCurrentPage(), this.lastPage.show(), this.lastPage && "singleSettlementPgae" == this.lastPage.name && this.game.reporter.rpSingleSettleRankCloseRank(), 
        ...
        key: "gotoRelayMode",
        value: function() {
            this.model.getIsRelayNewBie() ? (console.log("去接龙新手指导"), c.default.emit(v.EVENT.SHOW_RELAY_GUIDE), 
        ...
        value: function() {
            var e = !1;
            this.lastSyncTime ? Date.now() - this.lastSyncTime > v.SYNC_DEBONCE_TIME && (e = !0, 
        ...
        value: function(e) {
            if (("function" == typeof wx.openUrl || "function" == typeof wx.navigateToMiniProgram) && "game" == this.game.stage && this.model.adInfo && this.model.adInfo.canShowAd && e.block && e.block.isAd) {
                ...
                }, this.game.UI.showAdAvator(this.game.camera, t.trademark_url, t.ad_url, t.navigateToMiniProgramData), 
                this.model.setAdTagInLS());
            }
        }
    }, {
