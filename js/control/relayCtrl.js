    ...
    return o(e, [ {
        ...
        value: function(e, t) {
            ...
            if (e) {
                ...
                var s = e.query.room_id, a = decodeURIComponent(e.query.router_id), l = e.query.version, r = e.shareTicket;
        ...
        value: function(e, t) {
            ...
            this.model.relayInfo.shareInfo && (this.afterShareRelay(this.model.relayInfo.shareInfo.sharePath, this.model.relayInfo.shareInfo.shareTicket), 
            this.model.relayInfo.shareInfo = null), this.model.relayInfo.room_seed = t.room_seed, 
            this.model.relayInfo.my_seat_no = t.my_seat_no, this.model.relayInfo.next_room_id = t.next_room_id, 
            this.model.relayInfo.room_wxa_code = "", this.setCheckGameInterval(), 0 != t.my_seat_no && 1 == t.game_status ? this.rejoinRelay() : this.changePage("roomPage", t);
        }
    }, {
