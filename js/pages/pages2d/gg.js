...
function r(e) {
    ...
    var o = e.context.btn;
    o.clearRect(0, 0, f.WIDTH, f.HEIGHT), (0, f.drawImageCenter)({
        self: e,
        src: "res/noplay.png",
        pos: [ 257, 607, 212, 84 ],
        type: "btn",
        cb: function() {
            e.noplay_time = 5, (0, f.drawText)({
                ...
                o.clearRect(0, 0, f.WIDTH, f.HEIGHT), (0, f.drawImageCenter)({
                    ...
                    type: "btn",
                    imgid: e.imgid.btn
                })) : (o.fillStyle = "white", o.fillRect((0, f.cx)(175), (0, f.cy)(590), (0, f.cwh)(30), (0, 
...
function o(e) {
    ...
    (0, f.drawImageCenter)({
        ...
        cb: function() {
            ...
            for (var i = 0; i < 3; i++) if (1 == e.myidx && 0 == i && t++, e.myidx != e.sotedRankList.length || 2 != i) {
                var n = "";
                n = e.myidx == t + 1 + i ? "#41bf8c" : "#888", e.sotedRankList[t + i] && function() {
                    (0, f.drawText)({
                        self: e,
                        color: n,
                        italic: !0,
                        ...
                        self: e,
                        color: "#888",
                        t: (0, f.cname)(e.sotedRankList[t + i].nickname, 14),
                        pos: [ 90 + 118 * (i + o), 394 ],
                        size: 14
                    }), (0, f.drawText)({
                        self: e,
                        size: 22,
                        special: !0,
                        t: e.sotedRankList[t + i].week_best_score || 0,
                        pos: [ 90 + 118 * (i + o), 426 ]
                    });
                    var r = 90 + 118 * (i + o);
                    (0, f.drawImageCenter)({
                        self: e,
                        round: !0,
                        src: e.sotedRankList[t + i].headimg,
                        pos: [ r, 355, 42, 42 ],
                        type: "bg",
                        cb: function() {
                            (0, f.drawImageCenter)({
    ...
    console.log((0, f.gtVersion)("2.1.0"), wx.getSystemInfoSync().platform, (0, f.gtAppVersion)("6.6.7")), 
    wx.createRewardedVideoAd && "reward" == e.opt.ad_type && ("ios" == wx.getSystemInfoSync().platform && (0, 
    f.gtAppVersion)("6.7.0") || (0, f.gtVersion)("2.1.2") && "android" == wx.getSystemInfoSync().platform && (0, 
    f.gtAppVersion)("6.6.7"))) e.opt.videoAd = wx.createIncentiveVideoAd({
        adUnitId: "adunit-d8b47b944fa90908"
    }), e.opt.videoAd.load().then(function() {
        console.log("load reward ad succ"), e.opt.loadAdSuc = !0, e.hasAd = !0, i(e), !!e.opt.onShowRewardAd && e.opt.onShowRewardAd();
    }).catch(function(t) {
    ...
    }), console.log("load reward ? "); else if (wx.createBannerAd && (0, f.gtVersion)("2.0.6")) {
        var o = f.WIDTH / f.Dpr;
        return f.HEIGHT / f.WIDTH < 736 / 414 && (o = Math.max((0, f.cx)(370) / f.Dpr, 300)), 
        e.bannerAd || (e.bannerAd = wx.createBannerAd({
            ...
            console.log("on resize", t.width, t.height), e.bannerAd && e.bannerAd.style && (f.HEIGHT / f.WIDTH > 736 / 414 ? e.bannerAd.style.top = f.HEIGHT / f.Dpr - t.height - 20 : e.bannerAd.style.top = f.HEIGHT / f.Dpr - t.height, 
            t.height > 180 ? e.bannerAd.hide() : f.HEIGHT / f.WIDTH < 736 / 414 && (e.bannerAd.style.width = o, 
            e.bannerAd.style.left = (f.WIDTH / f.Dpr - o) / 2));
        });
    }
    p(e);
}
...
function i(e) {
    e.canvasType == f.CANVASTYPE.gameOver && (e.context.bg.strokeStyle = "rgba(255,255,255,0.06)", 
    (0, f.drawImageCenter)({
        round: !0,
        self: e,
        src: "res/bl3.png",
...
function n(e) {
    ...
    var o = e.context.btn;
    o.clearRect(0, 0, f.WIDTH, f.HEIGHT), r.lineWidth = 1 * f.Dpr, r.strokeStyle = "rgba(255,255,255,0.06)";
    var i = 401;
    0 == e.changlleList.length && (i = 318), (0, f.roundedRect)((0, f.cx)(30), (0, f.cy)(104), (0, 
    f.cwh)(354), (0, f.cwh)(i), 4 * f.Dpr, r), r.strokeStyle = "rgba(255,255,255,0.06)", 
    (0, f.drawImageCenter)({
        round: !0,
        self: e,
        src: "res/bl3.png",
        pos: [ 207, 104 + i / 2, 354, i ],
        type: "bg",
        imgid: e.imgid.bg,
        radius: 4 * f.Dpr,
        cb: function() {
            ...
            var o = 0;
            0 != e.changlleList.length && (o = 82), r.fillRect((0, f.cx)(30), (0, f.cy)(376 + o), (0, 
            f.cwh)(354), (0, f.cwh)(46)), (0, f.drawLine)(30, 375 + o, 384, 375 + o, "rgba(255,255,255,0.1)", .5, r), 
            (0, f.drawText)({
                self: e,
                size: 12,
                t: "查看全部排行",
                ...
                self: e,
                src: "res/r_arr.png",
                pos: [ 247, 397 + o, 6.6, 10 ],
                type: "bg",
                imgid: e.imgid.bg
            });
        }
    }), e.changlleList.length > 0 && (e.changlleListStart = 0, a(e, 0)), (o = e.context.btn).clearRect((0, 
...
function s(e, t) {
    ...
    o = "#509FC9") : e.opt.highest_score < 500 && e.opt.score >= 500 ? (r = "耐得寂寞", 
    o = "#E67600") : e.opt.highest_score < 1e3 && e.opt.score >= 1e3 ? (r = "登堂入室", 
    o = "#009D5E") : e.opt.highest_score < 2e3 && e.opt.score >= 2e3 ? (r = "无聊大师", 
    o = "#7A0096") : e.opt.highest_score < 3e3 && e.opt.score >= 3e3 && (r = "一指禅", 
    o = "#555555")), t.lineWidth = 1 * f.Dpr, t.strokeStyle = "#fff", t.fillStyle = "#fff", 
    ...
    t.fill(), t.lineWidth = 1 * f.Dpr, t.strokeStyle = o, t.fillStyle = o, (0, f.roundedRect)((0, 
...
function a(e, t) {
    if (e.imgid.btn++, !(e.changlleListStart + 5 * t < 0 || e.changlleListStart + 5 * t >= e.changlleList.length)) {
        ...
        var r = e.changlleList.slice(e.changlleListStart, e.changlleListStart + 5), o = r.length, i = 32, n = 207 - (32 * o + 10 * (o - 1)) / 2;
...
function c(e, t, r, o) {
    o = o || 0, (0, f.drawText)({
        ...
        t: t,
        pos: [ 212, 150 + o ]
    }), r.fillStyle = "rgba(255,255,255,0.2)", r.fillRect((0, f.cx)(162), (0, f.cy)(78 + o), (0, 
    f.cwh)(9), (0, f.cwh)(3)), r.fillRect((0, f.cx)(162), (0, f.cy)(84 + o), (0, f.cwh)(9), (0, 
    f.cwh)(3)), r.fillRect((0, f.cx)(241), (0, f.cy)(78 + o), (0, f.cwh)(9), (0, f.cwh)(3)), 
    r.fillRect((0, f.cx)(241), (0, f.cy)(84 + o), (0, f.cwh)(9), (0, f.cwh)(3));
}

function p(e, t) {
    e.canvasType == f.CANVASTYPE.gameOver && (t = t || 607, e.replayBtnPosy = t, (0, 
    f.drawImageCenter)({
        self: e,
        src: "res/2d/new_home.png",
        pos: [ 76, t, 74, 74 ],
...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.routeGameOver = function(e, i) {
    (0, f.createPlane)(e);
    var s = e.opt;
    ...
    r(e)) : (e.opt.type = "gg", o(e));
}, exports.gameOverEve = function(e, t, r) {
    return console.log("gameOverEve", t, r), "skin" != e.opt.type && t > 42 && t < 110 && r > e.replayBtnPosy - 50 && r < e.replayBtnPosy + 50 && b.default.emitSync(w.EVENT.GOSTARTPAGE, {}), 
    "tired" != e.opt.type && "skin" != e.opt.type && t > 168 && t < 340 && r > e.replayBtnPosy - 50 && r < e.replayBtnPosy + 50 ? ((0, 
