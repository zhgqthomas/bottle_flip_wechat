...
var i = function() {
    ...
    function w(i, o) {
        ...
        this.radiusSegments = 4, this.height = s.BLOCK.height, this.canChange = !0, 0 == i) {
            ...
            var B = [ new t.MeshLambertMaterial({
                ...
                transparent: !0
            }) ], L = new t.Geometry(), x = u, k = new t.CylinderGeometry(2, 2, 1, 50), _ = new t.PlaneGeometry(1.5, 1.5);
            this.geometry = x, this.merge(L, x, 0, [ {
                x: 0,
                y: 0,
                z: 0
            } ]), k.rotateX(Math.PI / 2), this.merge(L, k, 0, [ {
                x: 0,
                y: 0,
                z: s.BLOCK.radius + .51
            } ]), k.rotateZ(Math.PI / 2), k.rotateY(Math.PI / 2), this.merge(L, k, 0, [ {
                x: -s.BLOCK.radius - .51,
                y: 0,
                z: 0
            } ]), this.merge(L, _, 1, [ {
            ...
            } ]), _.rotateY(-Math.PI / 2), this.merge(L, _, 1, [ {
            ...
            var A = new t.MeshLambertMaterial({
                ...
                transparent: !0
            }), _ = new t.PlaneGeometry(6, 3), B = [ A, T ], L = new t.Geometry();
            this.merge(L, x, 0, [ {
                x: 0,
                y: 0,
                z: 0
            ...
            }), _ = new t.PlaneGeometry(3, 3), B = [ T ], L = new t.Geometry();
            ...
            this.mapUv(310, 310, x, 4, 200, 110, 310, 310), this.hitObj = new t.Mesh(x, S);
        } else if (15 == i) {
            x = new t.BoxGeometry(2 * s.BLOCK.radius, this.height, 2 * s.BLOCK.radius);
            ...
            this.glowMap = s.loader.load("res/glow_bag.png"), this.hitObj = new t.Mesh(x, S), 
            this.whenSucceed = this.glow, this.beforePopup = this.hideGlow, this.score = 20;
        } else if (16 == i) {
            var x = new t.BoxGeometry(2 * s.BLOCK.radius, this.height, 2 * s.BLOCK.radius), S = new t.MeshLambertMaterial({
                map: s.loader.load("res/dict.png")
            });
            this.mapUv(428, 428, x, 1, 0, 148, 280, 0), this.mapUv(428, 428, x, 2, 0, 148, 280, 428), 
            this.mapUv(428, 428, x, 4, 280, 148, 428, 428), this.hitObj = new t.Mesh(x, S);
        } else if (17 == i) {
            this.height /= 3;
            ...
            var S = new t.MeshLambertMaterial({
                ...
                transparent: !0,
                opacity: .3
            }), f = new t.BoxGeometry(2.05 * s.BLOCK.radius, s.BLOCK.height / 21 * 17, 2.05 * s.BLOCK.radius), B = [ S, Y = new t.MeshBasicMaterial({
            ...
            var _ = new t.CircleGeometry(.9 * s.BLOCK.radius, 40), T = new t.MeshBasicMaterial({
                map: s.loader.load("res/record.png")
            });
            (Me = new t.Mesh(_, T)).rotation.x = -Math.PI / 2, Me.position.y = .26, this.record.add(Me), 
            this.body.add(this.record);
            _ = new t.PlaneGeometry(2, 2);
            this.musicIcon = new t.Mesh(_, new t.MeshBasicMaterial({
            ...
            this.musicIcon.visible = !1, this.secondMusicIcon = new t.Mesh(_, new t.MeshBasicMaterial({
            ...
            var S = new t.MeshLambertMaterial({
                ...
                transparent: !0
            }), _ = new t.PlaneGeometry(3, 3), B = [ R, S ], L = new t.Geometry();
            ...
            } ]), this.hitObj = new t.Mesh(L, B), this.plane = new t.Mesh(_, new t.MeshBasicMaterial({
            ...
            this.geometry = x;
            var _ = new t.CircleGeometry(.7 * s.BLOCK.radius, 50), f = new t.CylinderGeometry(.7 * s.BLOCK.radius, .5 * s.BLOCK.radius, s.BLOCK.height / 21 * 17, 50), S = new t.MeshBasicMaterial({
                color: 5066061
            }), T = new t.MeshLambertMaterial({
            ...
            this.merge(L, x, 0, [ {
                ...
                y: -s.BLOCK.height / 21 * 10.5,
                z: 0
            } ]), _.rotateX(-Math.PI / 2), _.rotateY(-.7), this.merge(L, _, 2, [ {
                x: 0,
                y: this.height / 2 + .01,
                z: 0
            } ]), this.hitObj = new t.Mesh(L, B);
            ...
            this.hitObj = new t.Mesh(x, S), this.shadow = new t.Mesh(new t.PlaneGeometry(this.shadowWidth, this.shadowWidth), new t.MeshBasicMaterial({
            ...
            var B = [ S = new t.MeshLambertMaterial({
                ...
                transparent: !0
            }) ], _ = new t.PlaneGeometry(3.1, 3.1), L = new t.Geometry();
            ...
            this.merge(L, f, 1, [ {
                ...
                y: -s.BLOCK.height / 21 * 10.5,
                z: 0
            } ]), _.rotateY(-Math.PI / 2), this.merge(L, _, 2, [ {
            ...
            var X = p, W = new t.CylinderGeometry(1, 1, 1, 30), B = [ S, X ], L = new t.Geometry();
            this.merge(L, x, 0, [ {
                x: 0,
                y: 0,
                z: 0
            ...
            this.mapUv(280, 428, x, 4, 0, 0, 280, 148, !0), this.hitObj = new t.Mesh(x, S), 
            this.score = 5;
        } else if (27 == i) {
            ...
            var S = new t.MeshBasicMaterial({
                map: s.loader.load("res/golf_bottom.png")
            }), _ = new t.CircleGeometry(2 * s.BLOCK.radius / 38 * 25 + .01, 30), T = new g({
                map: s.loader.load("res/golf_top.png")
            }), L = new t.Geometry(), B = [ S, T ];
            x.rotateY(3), this.merge(L, x, 0, [ {
                x: 0,
                y: 0,
                z: 0
            } ]), _.rotateX(-Math.PI / 2), _.rotateY(-.7), this.merge(L, _, 1, [ {
                x: 0,
                y: this.height / 2 + .01,
                z: 0
            ...
            }), _ = new t.CircleGeometry(2 * s.BLOCK.radius / 38 * 15 + .01, 30), T = new g({
            ...
            this.geometry = x;
            var S = p, _ = new t.CircleGeometry(.4 * s.BLOCK.radius, 50), T = new t.MeshBasicMaterial({
                color: 16777215
            ...
            }), L = new t.Geometry(), B = [ S, T, Y ];
            this.merge(L, x, 0, [ {
                x: 0,
                y: 0,
                z: 0
            } ]), _.rotateX(-Math.PI / 2), this.merge(L, _, 1, [ {
                x: 0,
                y: this.height / 2 + .01,
                z: 0
            } ]), this.merge(L, H, 1, [ {
            ...
            var ae = new t.MeshLambertMaterial({
                color: 2199e3
            }), oe = new t.Mesh(new t.BoxGeometry(10, .4, 1.5), ae), he = new t.MeshLambertMaterial({
                color: 4531468
            }), re = new t.MeshLambertMaterial({
                color: 8037621
            });
            this.earBlack = new t.Mesh(new t.BoxGeometry(1.2, 3.5, 3.5), he), this.earBlue = new t.Mesh(new t.BoxGeometry(1, 2.5, 2.5), re), 
            oe.position.set(0, .8, 5.75), this.body.add(oe), this.earBlack.position.set(-5.4, 0, 0), 
            this.earBlue.position.set(-6, 0, 0), this.body.add(this.earBlue), this.body.add(this.earBlack), 
            this.hitObj = new t.Mesh(x, S), this.musicName = "luban", this.score = 20;
            _ = new t.PlaneGeometry(2, 2);
            this.icons = [];
            for (var ne = s.loader.load("res/music_icon_two.png"), N = 0; N < 4; ++N) this.icons[N] = new t.Mesh(_, new t.MeshBasicMaterial({
                map: ne,
                transparent: !0
            ...
            (_ = new t.CircleGeometry(1.8, 30)).rotateX(Math.PI / 2), _.rotateY(-Math.PI / 2);
            ...
            }), ye = new t.Mesh(_, T), pe = new t.Mesh(_, ue);
            ...
            (_ = new t.CircleGeometry(1.5, 30)).rotateX(Math.PI / 2), _.rotateY(-Math.PI / 2);
            var T = new t.MeshBasicMaterial({
                map: s.loader.load("res/relax_back.png")
            }), we = new t.MeshBasicMaterial({
                map: s.loader.load("res/relax_front.png"),
                side: t.DoubleSide
            }), Me = new t.Mesh(_, T), Be = new t.Mesh(_, we);
            ...
            if (1 == je.block_type) {
                ...
                var S = new t.MeshBasicMaterial({
                    map: s.loader.load(wx.env.USER_DATA_PATH + "/" + je.block_res_list[0].path)
                }), _ = new t.CircleGeometry(s.BLOCK.radius + .01, 30), T = new g({
    ...
    return i(w, [ {
        ...
        key: "_mapUv",
        value: function(e, i, s, a, o, h, r, n, l) {
            var d = 1 / e, m = 1 / i;
            if (s.faces[a] instanceof t.Face3) {
                c = s.faceVertexUvs[0][2 * a];
                4 == a && !l || 2 == a && l ? (c[0].x = o * d, c[0].y = h * m, c[2].x = o * d, c[2].y = n * m, 
                c[1].x = r * d, c[1].y = h * m) : (c[0].x = o * d, c[0].y = h * m, c[1].x = o * d, 
                c[1].y = n * m, c[2].x = r * d, c[2].y = h * m);
                var c = s.faceVertexUvs[0][2 * a + 1];
                4 == a && !l || 2 == a && l ? (c[2].x = o * d, c[2].y = n * m, c[1].x = r * d, c[1].y = n * m, 
                c[0].x = r * d, c[0].y = h * m) : (c[0].x = o * d, c[0].y = n * m, c[1].x = r * d, 
                c[1].y = n * m, c[2].x = r * d, c[2].y = h * m);
            }
        }
    }, {
        ...
        value: function(e, i) {
            for (var t = this, s = [ {
                ...
                y: 0,
                z: 3
            } ], o = 0; o < 4; ++o) this.icons[o].material.opacity = 0, this.icons[o].position.x = i.x - this.obj.position.x + .2, 
            this.icons[o].position.y = 9, this.icons[o].position.z = i.z - this.obj.position.z - .2, 
        ...
        value: function(e, i, t) {
            if (this.canChange) {
                if (this.order >= 9) {
                    ...
                    return this.radiusScale = t || Math.max((0, o.random)() * (s.BLOCK.maxRadiusScale - s.BLOCK.minRadiusScale) + s.BLOCK.minRadiusScale, this.min || a), 
                ...
                this.radiusScale = t || (0, o.random)() * (s.BLOCK.maxRadiusScale - s.BLOCK.minRadiusScale) + s.BLOCK.minRadiusScale, 
                this.radiusScale = +this.radiusScale.toFixed(2), this.radius = e || this.radiusScale * s.BLOCK.radius, 
        ...
        value: function(e) {
            ...
            this.type != i && (this.type = i, "green" == i ? (this.greenMaterial.color.setHex(h.green), 
            this.whiteMaterial.color.setHex(h.white), this.middleLightGreenMaterial && this.middleLightGreenMaterial.color.setHex(h.middleLightGreen)) : "gray" == i ? (this.greenMaterial.color.setHex(h.white), 
            this.whiteMaterial.color.setHex(h.gray), this.middleLightGreenMaterial && this.middleLightGreenMaterial.color.setHex(h.middleLightGray)) : "black" == i && (this.greenMaterial.color.setHex(h.black), 
            this.whiteMaterial.color.setHex(h.lightBlack), this.middleLightGreenMaterial && this.middleLightGreenMaterial.color.setHex(h.middleLightBlack)));
        }
    }, {
        key: "getVertices",
        value: function() {
        ...
        value: function() {
            ...
            if (this.beforePopup && this.beforePopup(), 25 == this.order) {
                ...
                var o = new Date(), h = ("0" + o.getHours()).slice(-2), r = ("0" + o.getMinutes()).slice(-2);
                this.numbers[h[0]][0].position.x = -3.1 * this.radiusScale, this.numbers[h[0]][0].visible = !0, 
                this.numbers[h[1]][1].position.x = -1.2 * this.radiusScale, this.numbers[h[1]][1].visible = !0, 
